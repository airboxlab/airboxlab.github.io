...
To do that, we'll first map our system and learned policy with functions approximations that govern it:
...
![sources]({{ site.baseurl }}/assets/ar_policy/jac_f_ar.png){: .center }
